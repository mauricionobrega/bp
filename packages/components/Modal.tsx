  ...
  return (
    <div className={open ? styles.modalShow : styles.modalHide}>
      <div className={styles.modalContainer}>
        ...
        <a className={styles.modalClose} aria-hidden="true" onClick={()=> props.setOpen(!props.open)}>&#x2715;</a>
        <p className={styles.headline}>R$ 200 de desconto no plano Acesso Total</p>
        <Countdown open={open} />
        <p className={styles.paragraph}>Histórias emocionantes que transformaram pontos finais em pontos de partida.</p>
